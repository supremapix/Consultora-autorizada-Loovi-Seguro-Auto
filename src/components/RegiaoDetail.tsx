  ...
  return (
    <div className="bg-white text-slate-900 min-h-screen pt-24 pb-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 text-xs sm:text-sm text-slate-600 flex items-center gap-2 flex-wrap">
        ...
        <span>/</span>
        <span className="text-[#6D2DBF] font-bold">{regiao.name}</span>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="bg-gradient-to-br from-purple-900 via-[#481773] to-[#6D2DBF] border border-purple-200 rounded-3xl p-6 sm:p-10 relative overflow-hidden shadow-xl text-white">
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold font-sora text-white tracking-tight leading-tight mb-4">
            Seguro Auto Loovi na <span className="text-[#2ED9A0]">{regiao.name}</span>
          </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2 mb-8">
            ...
            <div className="p-4 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 flex items-center gap-3">
              ...
              <div>
                <span className="text-xs text-slate-200 block font-medium">Atendimento Direct</span>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-slate-50 border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-sm">
            <h2 className="text-2xl font-bold font-sora text-slate-900 mb-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-2xl bg-white border border-slate-200 shadow-sm">
                <h3 className="font-bold text-slate-900 text-base mb-1">Proteção Total de Roubo e Furto</h3>
                <p className="text-xs text-slate-600">Ressarcimento de até 100% da Tabela FIPE com rastreamento ativo.</p>
              </div>

              <div className="p-4 rounded-2xl bg-white border border-slate-200 shadow-sm">
                <h3 className="font-bold text-slate-900 text-base mb-1">Danos a Terceiros até R$ 100 mil</h3>
                <p className="text-xs text-slate-600">Sua garantia contra batidas em outros veículos nas ruas da {regiao.name}.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-sm">
            <h2 className="text-2xl font-bold font-sora text-slate-900 mb-4 flex items-center gap-3">
              <HelpCircle className="w-6 h-6 text-[#00875A]" />
              Dúvidas da {regiao.name}
            </h2>
            <div className="space-y-4">
              <div className="p-4 rounded-2xl bg-white border border-slate-200 shadow-sm">
                <h3 className="font-bold text-slate-900 text-sm sm:text-base mb-1">Como acionar a assistência 24h na {regiao.name}?</h3>
                <p className="text-xs sm:text-sm text-slate-600 font-medium">Ligue para o 0800 948 4888 ou acione via app Loovi para socorro imediato.</p>
              </div>
              <div className="p-4 rounded-2xl bg-white border border-slate-200 shadow-sm">
                <h3 className="font-bold text-slate-900 text-sm sm:text-base mb-1">Aceita motoristas de app Uber e 99 na {regiao.name}?</h3>
                <p className="text-xs sm:text-sm text-slate-600 font-medium">Sim! Aceitação total com 100% da Tabela FIPE garantida.</p>
              </div>
            </div>
          </div>
        </div>
